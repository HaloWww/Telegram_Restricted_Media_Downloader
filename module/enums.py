...
class BotCallbackText:
    ...
    SETTING: str = 'setting'
    BOT_USER_SETTING: str = 'bot_user_setting'
    BOT_USER_ADD: str = 'bot_user_add'
    BOT_USER_REMOVE: str = 'bot_user_remove'
    BOT_ADMIN_USER_ADD: str = 'bot_admin_user_add'
    BOT_ADMIN_USER_REMOVE: str = 'bot_admin_user_remove'
    BOT_USER_INPUT_CANCEL: str = 'bot_user_input_cancel'
...
class BotButton:
    ...
    RESELECT: str = '🔄重新选择'
    SETTING: str = '⚙️设置'
    BOT_USER_SETTING: str = '👥机器人用户权限'
    BOT_USER_ADD: str = '➕添加普通用户ID'
    BOT_ADMIN_USER_ADD: str = '➕添加管理员ID'
